...
| 3 | Ghost spawn/corner placement creates immediate unfair death | medium | high | omischle | spawn ghosts in maze corners, away from the center player spawn, plus 2s respawn grace |
